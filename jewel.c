...
char catagories[][25]={"Rings","Ear Rings","Bracelet","Pendant","Chain","Jewellery Set","Payal","Baby Bala","Bala","Waist Chain","Bichuya","Sindoor Kouta","Key Ring","Utencil","Pooja Samagri","Murthi","Locket","Finger Ring"};
...
char password[10]={"password"}; //replace "password" with your own if you wish to change the password
...
printf("\tJewellary Management System");
...
printf("\tSubham Sagar Paira - KL DEVELOPERS CO.@ 2018_Build---");
...
int i=0,j;
	...
	printf("\t\t\t\t\tWELCOME\n\t\t\t\t\t  To \n\t\t   \xB2\xB2\xB2\xB2\xB2\xB2 Jewellery Management System \xB2\xB2\xB2\xB2\xB2\xB2\n");
